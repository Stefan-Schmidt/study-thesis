...
indicator like packet loss and interesting by-product of our other test cases.
...
gradually decreases, the DTN throughput on the left chart of figure
\ref{fig:throughput_dtn} has some interesting amplitudes and trespasses. They
...
increased over the distance with 43 percent at 30m, as can be seen in table
\ref{tableloss}, and trespassed the 50 percent boarder from 33m upwards.
