...
that would allow you to flash another OS so the only way to get it bootstraped
...
0 and no code got exectued so far. Afterwards we disable the flash protection and
