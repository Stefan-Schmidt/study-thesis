...
Implementing and evaluating an IEEE 802.15.4 convergence layer for DTN was the aim
of this thesis. We discuss how we prepared the underlying Linux system and then
implemented the convergence layer for IBR-DTN. Based on this implementations we
evaluated data throughput as well as packetloss and round trip time for either
